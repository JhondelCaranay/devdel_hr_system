...
export const Route = createRootRouteWithContext<MyRouterContext>()({
  ...
  component: () => (
    <div className="min-h-screen relative">
      <HeadContent />
      <div className="absolute inset-0 -z-10 h-full w-full bg-blue-50 bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#33000000_1px,transparent_1px)] bg-[size:6rem_4rem]">
